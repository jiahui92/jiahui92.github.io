...
## nextjs
【[参考资料](https://nextjs.org/docs/api-reference/next/head)】
```js
...
## nuxt.js
【[参考资料](https://github.com/storyblok/nuxtjs-multilanguage-website/blob/master/nuxt.config.js)】
```js
// ~/nuxt.config.js
module.exports = {
  ...
...
## html-webpack-plugin
【[参考资料1](https://juejin.im/post/5c8c6212e51d4522fa2965ad)】【[参考资料2](https://github.com/jaketrent/html-webpack-template)】
```js
// webpack.config.js
{
  plugins: [
